function check_regex() {
	...
	if(!regex.test(new_password))
	{
		...
		document.getElementById('span_regex_new_password').innerHTML = '';
	}
	...
	if(!old_password)
	{
		document.getElementById('span_regex_old_password').innerHTML = "Điền mật khẩu cũ để cập nhật!";
		regex_check = false;
	} else {
		document.getElementById('span_regex_old_password').innerHTML = '';
	}
